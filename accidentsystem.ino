...
#define IFTTTKEY "hCBKFI0K2EaDE_56rt9PrLDcUG8Urbk-53DsZgG8xQV"
...
const char* ssid = "M53";   // Enter the namme of your WiFi Network.
const char* password = "icecream";  // Enter the Password of your WiFi Network.
